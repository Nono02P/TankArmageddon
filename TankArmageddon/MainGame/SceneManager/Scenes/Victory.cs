...
namespace TankArmageddon
{
    public class Victory : Scene
    {
        ...
        private Textbox _winner;
        private Tweening _tweeningWinner;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            _tweeningWinner.Update(gameTime);
            ...
            _winner.Position = new Vector2(_tweeningWinner.Result, _winner.Position.Y);
